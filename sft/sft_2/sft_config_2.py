...
class SFTModelConfig:
    checkpoint_path: str = field(
        default="/from_s3/sft1_model/",
        metadata={"help": "Path to the SFT Stage 1 model weights."}
    )
    ...
    max_position_embeddings: int = field(
        default=4096, # Aligned with LLaMAConfig
    ...
    rms_norm_eps: float = field(
        default=1e-5, # Aligned with LLaMAConfig
...
class SFTTrainerConfig:
    ...
    output_dir: str = field(
        default="checkpoints/sft_stage2",
        metadata={"help": "Directory to save checkpoints."}
    )
    ds_config_path: str = field(
        default="sft/sft_1/ds_config_zero3.json",
